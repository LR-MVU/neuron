...
textAmp=open(outputFileName+"_translating_mRNA_no_mRNA_repeats.txt","w+")
...
summaryAmpDist=np.loadtxt(outputFileName+"_translating_mRNA_no_mRNA_repeats.txt", skiprows=1, dtype=str)
...
textDistance=open(outputFileName+"_Translating_mRNA_no_repeats.txt","w+")
    ...
    if len(repeatedEntries[0])>1:
        ...
        for entry in repeatedEntries[0]:
            ...
            if float(summaryAmpDist[entry, 6]) < distance_min:
                if entry_id != -1:
                    untranslating_list += [[summaryAmpDist[entry_id,0],summaryAmpDist[entry_id,1],summaryAmpDist[entry_id,2],summaryAmpDist[entry_id,7],summaryAmpDist[entry_id,8],summaryAmpDist[entry_id,9]]]
                entry_id = entry
                distance_min = float(summaryAmpDist[entry,6])
            else:
                untranslating_list += [[summaryAmpDist[entry,0],summaryAmpDist[entry,1],summaryAmpDist[entry,2],summaryAmpDist[entry,7],summaryAmpDist[entry,8],summaryAmpDist[entry,9]]]
...
untranslating_txt = open(untranslating_txt_path, "a+")
summaryAmpDist=np.loadtxt(outputFileName+"_translating_mRNA_no_repeats.txt", skiprows=1, dtype=str)
untranslating_list_filtered = []
for row in untranslating_list:
    if row[2] not in summaryAmpDist[:,2]:
        untranslating_txt.write("\t".join(row)+"\n")
untranslating_txt.close()
...
############################### clean up ###############################
os.remove(outputFileName+"_translating_mRNA_no_mRNA_repeats.txt")
print("done")
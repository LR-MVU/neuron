...
class Dendrite:
    ...
    def __init__(self, img_name):
        ...
        self.spot_distribution = {} #distribution of spots along skeleton?
        self.printDistribution = {} #sorted print coordinates: #{'0-25':[list of print coords],'25-50':[list of mrna coords],etc}
        self.spot_coords_sorted = {} #{channel: {'0-25':[list of mrna coords],'25-50':[list of mrna coords],etc}, etc}
        self.start_end = None
        
        self.skel_points = [] #list of skeleton coordinates, in order
        self.skel_distances = [] #distance bw skeleton coordinates, in order
        
        self.spot_distances = {}
        self.simulated_spots = {}
        self.simulated_spot_distances = {}
